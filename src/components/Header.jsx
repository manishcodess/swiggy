  ...
  return (
    <>
      ...
      <div className="bg-[#ff5900] pt-16 pb-8  flex items-center relative">
        <img
          className="w-62 h-112 absolute top-0 left-0"
          src="https://media-assets.swiggy.com/swiggy/image/upload/fl_lossy,f_auto,q_auto/portal/testing/seo-home/Veggies_new.png"
          alt=""
        />
        <div className="mx-60">
          <div className=" text-white font-bold text-5xl  h-30 container text-center  ">
          ...
          <div id="search2" className="flex gap-7 mx-42">
            <input
              ...
              className=" bg-amber-50 rounded-xl w-70 h-15 px-3 "
            />
            <input
              type="text"
              placeholder="search for restaurant,item or more"
              className=" bg-amber-50 rounded-xl w-120 px-3 border-amber-50 "
            />
          </div>
        </div>
        <img
          className="w-62 h-112 absolute top-0 right-0 "
