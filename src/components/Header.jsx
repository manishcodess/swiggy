    ...
    <>
      ...
      <div className="bg-[#ff5900] h-82">
        <div className="flex justify-around mx-80 w-[60%]" >
           <a href="https://www.swiggy.com/restaurants"> <img className="h-72 w-73" src="https://media-assets.swiggy.com/swiggy/image/upload/fl_lossy,f_auto,q_auto/MERCHANDISING_BANNERS/IMAGES/MERCH/2024/7/23/ec86a309-9b06-48e2-9adc-35753f06bc0a_Food3BU.png" alt="" /> </a>
