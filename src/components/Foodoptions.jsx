...
export default function Foodoptions(){
    ...
    return(<div className=" h-104 w-[80%]  container mx-auto">
        ...
        <div className="flex flex-wrap overflow-x-hidden gap-5"> { Fooddata.map((val)=>{ return <Foodoption key={val.id} link={'https://media-assets.swiggy.com/swiggy/image/upload/fl_lossy,f_auto,q_auto/'+val?.imageId}/> })}</div>
